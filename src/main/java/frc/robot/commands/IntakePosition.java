    ...
    if (this.mode.Mode == true) {
      ...
      if (this.intake.detectBeamBreaker1() == false&& Groundonce) {
        ...
        if (this.intake.PositionIntake() >= 80 && count < 1 ) {
          ...
          this.grip.Grip();
          Groundonce = false;
          SmartDashboard.putString("Check Loop","8");
        }
        
      }
     
      if (this.intake.detectBeamBreaker1() == true && once) {
        // this.arm.setArmspeed(0.1);
        // this.arm.setElbowspeed(0.1);
        this.intake.IntakeCube(0);
        this.grip.IsGrip(false);
        ...
        flag = false;
        count = 3;
        SmartDashboard.putString("Check Loop","11");
        ...
        flag = false;
        returnflag = true;
        SmartDashboard.putString("Check Loop","12");
