...
//   public PoseEstimator(PhotonCamera photonCamera, Swerve swerveSubsystem) {
...
//     poseEstimator.updateWithTime(Timer.getFPGATimestamp(), swerveSubsystem.getGyroRotation(), swerveSubsystem.getModulePositions());
...
//     poseEstimator.resetPosition(swerveSubsystem.getGyroscopeRotation(),swerveSubsystem.getModulePositions(),pose );
//   }
